...
{
    public class ModbusAscMaster : IDisposable
    {
        ...
        public ModbusAscMaster(string portName, int baudRate = 9600, Parity parity = Parity.None, int dataBits = 8, StopBits stopBits = StopBits.One)
        {
            _portName = portName;
            _baudRate = baudRate;
            _parity = parity;
        ...
        public void Connect()
        {
            ...
            try
            {
                ...
                _isConnected = true;
                OnLogReceived(LoggingLevel.Information, $"Connected to {_portName} ({_baudRate},{_parity},{_dataBits},{_stopBits}) (ASCII)");
            }
            catch (Exception ex)
            {
