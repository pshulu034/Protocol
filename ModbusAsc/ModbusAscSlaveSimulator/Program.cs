...
namespace ModbusAscSlaveSimulator
{
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            Console.WriteLine($"Modbus ASCII Slave Simulator");
            ...
            try
            {
                using (SerialPort serialPort = new SerialPort(portName, baudRate, Parity.None, 8, StopBits.One))
                {
                    ...
                    IModbusSlaveNetwork network = factory.CreateAsciiSlaveNetwork(adapter);
                    ...
                    Console.WriteLine("Modbus ASCII Slave started.");
